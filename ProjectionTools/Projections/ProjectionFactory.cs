...
public readonly struct ProjectionFactory<TSource, TResult, TParam>
{
    ...
    // experimental
    internal Projection<TSource, TResult> For(Func<TParam> param)
    {
...
public readonly struct ProjectionFactory<TSource, TResult, TParam1, TParam2>
{
    ...
    // experimental
    internal Projection<TSource, TResult> For(Func<TParam1> param1, Func<TParam2> param2)
    {
        var expressionFactory = ExpressionFactory;
        var delegateFactory = DelegateFactory;
    ...
    // experimental
    internal ProjectionFactory<TSource, TResult, TParam2> For(Func<TParam1> param1)
    {
        var expressionFactory = ExpressionFactory;
        var delegateFactory = DelegateFactory;
